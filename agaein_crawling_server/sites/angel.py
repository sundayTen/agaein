            ...
            if response.status_code == 200:
                ...
                try:
                    ...
                    if crawlingPageType in ["목격", "구조"]:
                        ...
                        print(f"[angel] {index}번째 게시물은 목격 및 구조, 실종 게시물이 아닙니다.")
                        continue

                    db_sink["site"] = url
                    db_sink["created_date"] = (
                        str(soup.select(".about-info")[0])
                        .split("</em> ")[1]
                        .split(" ")[0]
                    )
                    db_sink["keywords"] = (
                    ...
                    db_sink["gender"] = (
                        "FEMALE"
                        if detail_data[1] == "암컷"
                        else ("MALE" if detail_data[1] == "수컷" else "UNKNOWN")
                    )
                    ...
                    db_sink["found_or_lost_date"] = re.split(r"[<>]", str(data[1]))[2]
