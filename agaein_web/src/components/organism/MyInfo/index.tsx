...
import { User, useUpdateUserMutation, useUserQuery, useUpdateProfileMutation } from 'graphql/generated/generated';
...
const MyInfo = ({ id }: Props) => {
    ...
    // const [modifyImage] = useUpdateProfileMutation();
